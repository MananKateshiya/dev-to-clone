...
function LeftSidebar() {
  return (
    <section className="flex flex-col">
      ...
      <h2 className="text-lg font-medium2 mx-2 mt-4 mb-2  max-md:hidden">
        Other
      </h2>
      <nav className="flex flex-col text-color_dark w-full font-thin2 max-md:hidden">
      ...
      <nav className=" max-md:hidden">
        <header className="flex items-center justify-between mx-2">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            className="crayons-icon rounded-md p-2 h-10 w-10 hover:bg-hoverAccent hover:fill-blue-900"
          >
        ...
        <div className="flex flex-col h-[42vh] p-1 overflow-y-scroll text-color_dark w-full font-thin2 max-md:hidden">
          {sidebarTags.map((tags) => (
            <Link
              key={tags.tag}
              href={`/t/${tags.tag}`}
              className=" flex items-center px-2 py-1.5 bg-transparent focus:focusRing focus:bg-hoverAccent hover:bg-hoverAccent hover:text-blue-900 hover:underline focus:underline rounded-md"
            >
              <span className="text-md py-1 focus:focusRing focus:bg-hoverAccent ">
                #{tags.tag}
              </span>
            </Link>
          ))}
